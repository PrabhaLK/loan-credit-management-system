...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            const maxMedicalCharges = parseFloat(<?php echo $IncidentPrice; ?>);
            const maxTestCharges = parseFloat(<?php echo $TestIncident; ?>);
            const maxConsultantFees = parseFloat(<?php echo  $consultantPrice; ?>);
