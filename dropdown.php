            ...
            <div id="navbar" class="navbar-collapse collapse">
               <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="" class="dropdown-toggle" data-toggle="dropdown">Cancer<b class="caret"></b></a>
                    </li>
                    ...
                    <li>
                        <a href="" class="dropdown-toggle" data-toggle="dropdown">Knee<b class="caret"></b></a>
                    </li>
                    
                    <li>
                        <a href="" class="dropdown-toggle" data-toggle="dropdown">Hip<b class="caret"></b></a>
                    </li>
                    
                    <li>
                        <a href="" class="dropdown-toggle" data-toggle="dropdown">Hearing Aid<b class="caret"></b></a>
                    </li>
                    
                    <li>
                        <a href="" class="dropdown-toggle" data-toggle="dropdown">Spectacles<b class="caret"></b></a>
                    </li>
                    ...
                    <li>
                        <a href="" class="dropdown-toggle" data-toggle="dropdown">Accident<b class="caret"></b></a>
                    </li>
